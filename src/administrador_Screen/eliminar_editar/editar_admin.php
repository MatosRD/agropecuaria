...
<div class="agre">
        <form action="" method="post">
            <div class="agre_2">
                ...
                include 'edita_v.php';
                ?>
                <label for="ven" >Usuario:</label>
                <input style="30px" id="cd" class="ipp" type="text" name="vendedor" value="<?php echo $vendedor ?>">
                <label for="descripcion" >Clave:</label>
                <input  style="30px" id="dc" type="text" name="clave" value="<?php echo $clave ?>">
