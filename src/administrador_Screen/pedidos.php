            ...
            <?php
                ...
                if(mysqli_num_rows($sql) > 0){
                    while($fila = mysqli_fetch_assoc($sql)){ 
                        $nop = $fila['nopedido'];
                        $contar = mysqli_query($conexion,"SELECT * FROM pedidos_c WHERE nopedido = '$nop' ");
                        $cant  = 0;
                        ...
                        <div class="car">
                            ...
                            <div class="tt">
                                ...
                                $cliente = $fila['estado']; 
                                if($cliente == 'activo'){
                                    echo '<p style="color: green; font-weight:800; " >' .$cliente. '</p>';
                                }else{
...
<?php 
    ...
    if(!empty($_POST['busca'])){ 
        $bus = $_POST['busca'];
        $sentencia = "SELECT * FROM pedidos_c WHERE nopedido like '$bus' or cliente = '$bus' ";
