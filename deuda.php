        ...
        <table  >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $fila['precio_d']  ?></td>
                    <td><?php echo $fila['cantidad_d']  ?></td>
                    <td><?php echo $fila['itbis']  ?></td>
                    <td><?php echo $fila['sub_d']  ?></td>
                    <td><?php echo $fila['fecha_a']  ?></td>
                    <td><?php echo $fila['abonacion']  ?></td>
                    <td><?php echo $fila['deuda']  ?></td>
                
                    <td>
                        <button type="button" id="ea"><?php echo"<a href='editar_d.php?id=".$fila['id_deuda']." '
                        >Editar</a>"; ?></button>            
                            <br>
                        <button type="button" id="ex"><?php echo"<a href='eliminar_d.php?id=".$fila['id_deuda']." '
